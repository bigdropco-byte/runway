...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/aviation/crosswind-calculator',
    title: 'Runway Crosswind Calculator – Headwind, Crosswind & Tailwind Vectors',
    description: 'Free runway crosswind calculator. Compute exact crosswind, headwind, and tailwind components with interactive runway compass visualization.'
  });
}
