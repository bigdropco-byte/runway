...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/aviation/runway-length-calculator',
    title: 'Runway Length Calculator – Density Altitude & Takeoff Distance',
    description: 'Free runway length and takeoff performance calculator. Compute density altitude, pressure altitude, and temperature-adjusted ground roll distance.'
  });
}
