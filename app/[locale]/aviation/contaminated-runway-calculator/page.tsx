...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/aviation/contaminated-runway-calculator',
    title: 'Contaminated Runway Calculator – FAA TALPA Landing Distance',
    description: 'Free contaminated runway landing distance calculator. Apply FAA TALPA RCAM braking action multipliers (RWYCC 1–6) for water, slush, snow, and ice.'
  });
}
