...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/aviation/runway-slope-calculator',
    title: 'Runway Slope Calculator – Runway Gradient & Takeoff Performance',
    description: 'Free runway slope calculator. Calculate longitudinal runway gradient percentage from threshold elevations and evaluate ICAO Annex 14 compliance.'
  });
}
