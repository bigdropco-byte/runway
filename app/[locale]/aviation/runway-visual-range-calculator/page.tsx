...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/aviation/runway-visual-range-calculator',
    title: 'Runway Visual Range Calculator – RVR to Visibility Converter',
    description: 'Free RVR to statute miles converter using official FAA AIM Table 7-1-10 standards. Convert RVR in feet and meters to meteorological visibility and CAT minimums.'
  });
}
