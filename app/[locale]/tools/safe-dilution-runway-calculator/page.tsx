...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/tools/safe-dilution-runway-calculator',
    title: 'SAFE & Dilution Runway Calculator – Post-Money Cap & Capital Gap',
    description: 'Free SAFE dilution and runway calculator. Compute capital shortfall for target 18-month runway, post-money valuation cap dilution, and founder equity.'
  });
}
