...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/tools/hiring-runway-calculator',
    title: 'Hiring Runway Calculator – Headcount Burn & Salary Runway Impact',
    description: 'Free hiring runway calculator. Model headcount additions, fully-loaded employee payroll with taxes and benefits (1.15x–1.30x), and see exact runway reduction.'
  });
}
