...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/tools/runway-calculator-excel',
    title: 'Runway Calculator Excel Template – Free 24-Month Model Download',
    description: 'Download free 24-month startup runway Excel template spreadsheet. Native spreadsheet formulas for monthly cash balance, net burn, and CSV export.'
  });
}
