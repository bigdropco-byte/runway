...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/tools/default-alive-calculator',
    title: 'Default Alive vs Default Dead Calculator – Paul Graham Model',
    description: 'Free Default Alive vs Default Dead calculator based on Paul Graham (Y Combinator) framework. Model compounding revenue growth and cash burn.'
  });
}
