...
export async function generateMetadata({
  ...
  return getLocalizedMetadata({
    locale,
    subpath: '/tools/cash-runway-calculator',
    title: 'Cash Runway Calculator – Liquid Reserve Runway & Cash Buffer',
    description: 'Free cash runway calculator. Calculate usable cash runway with emergency buffer deduction (0–50%), analyze gross vs net burn, and protect operating runway.'
  });
}
